 ...
 * Modifications:
 *
 * If statement should always use braces, even if they only contain one statement. The alternative is error-prone;
 *
 * A dotted statement spanning more than one line should end with the dot on each line instead of beginning with the
 * dot on the next line. It improves readability (IMHO).
 */
